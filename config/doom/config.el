...
;; accept. For example:
;; (setq doom-font (font-spec :family "Essential PragmataPro" :size 12))
;; Essential PragmataPro:pixelsize=16:foundry=FSD :weight=normal:slant=normal:width=normal:spacing=100:scalable=true
(setq doom-font (font-spec :family "Essential PragmataPro" :size 12.0))
...
(after! rust-mode
  ...
  (setq lsp-rust-analyzer-cargo-run-build-scripts nil)
                                        ; (setq lsp-rust-analyzer-cargo-load-out-dirs-from-check 'f)
